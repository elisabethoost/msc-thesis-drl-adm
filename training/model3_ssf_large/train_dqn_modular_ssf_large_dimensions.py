...
from scripts.utils_ssf_large_dimensions import NumpyEncoder
    ...
    def train_dqn_agent(env_type, seed):
        ...
        def cross_validate_on_test_data(model, current_episode, log_data):
            ...
            for test_scenario_folder in test_scenario_folders:
                ...
                # Use Model 3 (same as minimal_env)
                ...
                env = AircraftDisruptionEnv(
                    ...
                    config_dict,
                    env_type=env_type,
                    max_flights_total=max_flights  # <-- Must match minimal_env
                )
        ...
        # Model 3: Use environment_ssf_large_dimensions with optimized max_flights_total
        ...
        while total_timesteps < MAX_TOTAL_TIMESTEPS:
            ...
            for scenario_folder in scenario_folders:
                ...
                # Use Model 3 (same as minimal_env) - AircraftDisruptionEnv is already imported at top
                env = AircraftDisruptionEnv(
                    aircraft_dict,
                    flights_dict,
                    rotations_dict,
                ...
                for aircraft_id in env.aircraft_ids:
                    ...
                    start_col = env.unavailabilities_dict[aircraft_id]['StartColumn']
                    end_col = env.unavailabilities_dict[aircraft_id]['EndColumn']
