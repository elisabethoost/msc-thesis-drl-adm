...
Usage:
    python InterpretationAnalysisVisualisations/visualize_episode_metrics.py
    OR
...
def main():
    ...
    MODEL_FOLDER = "Final_Model_20_wPenalty10/3ac-130-green"  # Path to your model folder (relative to project root)
